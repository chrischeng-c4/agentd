...
### R5: Display of Existing Annotations
...
### Scenario: Add an annotation to a requirement
...
### Scenario: Load existing annotations
...
### Scenario: Resolve an annotation
